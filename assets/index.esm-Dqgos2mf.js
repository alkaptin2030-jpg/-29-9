import{c as ee,r as te,j as ne,T as ke,x as Ee,at as Ae,au as Oe,av as X,aw as Ue,ax as Ne,ay as x,az as Ie,aA as Pe,aB as xe,aC as re,aD as Ce,aE as De,aF as ve,aG as Se}from"./index-B05GXhax.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qt=ee("Search",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["path",{d:"m21 21-4.3-4.3",key:"1qie3q"}]]);var Le="Separator",K="horizontal",Be=["horizontal","vertical"],se=te.forwardRef((e,t)=>{const{decorative:n,orientation:r=K,...s}=e,o=Fe(r)?r:K,a=n?{role:"none"}:{"aria-orientation":o==="vertical"?o:void 0,role:"separator"};return ne.jsx(ke.div,{"data-orientation":o,...a,...s,ref:t})});se.displayName=Le;function Fe(e){return Be.includes(e)}var oe=se;const Me=te.forwardRef(({className:e,orientation:t="horizontal",decorative:n=!0,...r},s)=>ne.jsx(oe,{ref:s,decorative:n,orientation:t,className:Ee("shrink-0 bg-border",t==="horizontal"?"h-[1px] w-full":"h-full w-[1px]",e),...r}));Me.displayName=oe.displayName;/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Te="storage";function en(e,t,n){return e=x(e),jt(e,t,n)}function tn(e){return e=x(e),$t(e)}function nn(e){return e=x(e),Ht(e)}function rn(e,t){return e=x(e),Wt(e,t)}function sn(e=xe(),t){e=x(e);const r=Ie(e,Te).getImmediate({identifier:t}),s=Pe("storage");return s&&Kt(r,...s),r}function Kt(e,t,n,r={}){Xt(e,t,n,r)}function Gt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return new W(n,r,s,t,Ue)}function Yt(){Ae(new Oe(Te,Gt,"PUBLIC").setMultipleInstances(!0)),X(J,Q,""),X(J,Q,"esm2020")}Yt();export{Jt as P,Qt as S,Me as a,tn as b,nn as d,sn as g,rn as r,en as u};
